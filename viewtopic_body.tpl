        ...
        <div class="post_profile" id="profile{postrow.displayed.U_POST_ID}">
            ...
            <center>
                <span class="post_pseudo">
                  {postrow.displayed.POSTER_NAME} <!-- Pseudo --> <br />
                  <span class="post_rank">{postrow.displayed.POSTER_RANK_NEW} <!-- Rang --> </span>
              </span>
            </center>
			...
			<!-- Séparateur entre champs de profil -->                      
              ...
              <div>
                <span>HRP</span>
                <div class="hrp"><!-- Les champs du profil seront déplacés ici --></div>
              </div>
